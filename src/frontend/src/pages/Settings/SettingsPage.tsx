    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                const [tagIds, statusIds, priorityIds] = await Promise.all([
                    apiService.getTags(),
                    ...
                    <div className="mx-auto w-full max-w-6xl">
                        <div className="flex flex-col space-y-2">
                            ...
                            <p className="text-muted-foreground">
                                View system configuration including tags, statuses, and priorities. 
                            ...
                            <TabsContent value="tags" className="space-y-4">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Available tags for categorizing issues
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <Table>
                            ...
                            <TabsContent value="statuses" className="space-y-4">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Available statuses for tracking issue progress
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <Table>
                            ...
                            <TabsContent value="priorities" className="space-y-4">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Available priority levels for issues
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <Table>
                                                    ...
                                                    priorities
                                                        ...
                                                        .map((priority) => (
                                                            <TableRow key={priority.id}>
                                                                ...
                                                                <TableCell>
                                                                    <Badge variant={priority.level >= 4 ? 'destructive' : priority.level >= 2 ? 'default' : 'secondary'}>
